...
export class ContactService {
    ...
    findAll(): Observable<Contact[]> {
      console.log('from contact service findAll');
    ...
    set(contact: Contact) {
        this.proxy.set(this.controller, contact).subscribe(
            data => {
                this.emitChanges();
    ...
    add(contact: Contact): Contact {
        this.proxy.add(this.controller, contact).subscribe(
            data => {
                this.emitChanges();
                this.toastr.success('Item was saved successfully', 'Save');
                return data;
    ...
    delete(contact: Contact) {
        this.proxy.delete(this.controller, contact.id).subscribe(
            data => {
                this.emitChanges();
                  this.toastr.success(
