...
export class AccountService {
    ...
    accountListChanged = new Subject<Account[]>();
    ...
    private emitChanges() {
        this.findAll().subscribe(data => {
            ...
            this.accountListChanged.next(this.accountList);
        });
    }

    findAll(): Observable<Account[]> {
      console.log('from account service findAll');
    ...
    set(account: Account): Account {
        this.proxy.set(this.controller, account).subscribe(
            data => {
                this.emitChanges();
    ...
    add(account: Account): Account {
        this.proxy.add(this.controller, account).subscribe(
            data => {
                this.emitChanges();
                this.toastr.success('Item was saved successfully', 'Save');
                return data;
    ...
    delete(account: Account) {
        this.proxy.delete(this.controller, account.id).subscribe(
            data => {
                this.emitChanges();
                  this.toastr.success(
