...
@Component({
  selector: 'app-rejet-edit',
  templateUrl: './rejet-edit.component.html',
  styleUrls: ['./rejet-edit.component.css']
})
export class RejetEditComponent implements OnInit {
  ...
  onSubmit() {
    ...
    this.selectedOrderTransportRejectType.type=1;
