...
@Component({
  selector: "app-merchandise-aller-edit",
  templateUrl: "./merchandise-aller-edit.component.html",
  styleUrls: ["./merchandise-aller-edit.component.scss"],
})
export class MerchandiseAllerEditComponent implements OnInit {
...
packageDetails: PackageDetail[] = [];
  ...
  ngOnInit() {
   ...
   this.selectedDeliveryInfo =this.orderDeliveryService.getDeliveryInfoAller()?this.orderDeliveryService.getDeliveryInfoAller():new DeliveryInfo();
  ...
  this.orderDeliveryService.addDeliveryInfoAller(this.selectedDeliveryInfo);
  }

  initFormSource() {
    let formValue = this.deliveryInfoForm.value;
    if (this.isExistAccountOrderTypeAllerSource == "true") {
      this.selectedAddressContactDeliveryInfoSource.name =
  ...
  initFormDistination() {
    let formValue = this.deliveryInfoForm.value;
    if (this.isExistAccountOrderTypeAllerDistinataire == "true") {
      this.selectedAddressContactDeliveryInfoDestination.name =
