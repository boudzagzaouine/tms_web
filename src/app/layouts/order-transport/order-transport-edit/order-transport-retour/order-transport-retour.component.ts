...
export class OrderTransportRetourComponent implements OnInit {
  ...
  selectedAddressContactOrderTransportInfoInitial: AddressContactOrderTransportInfo = new AddressContactOrderTransportInfo();
  selectedAddressContactOrderTransportInfoFinal: AddressContactOrderTransportInfo =new AddressContactOrderTransportInfo();
  ...
  ngOnInit() {
   ...
   this. selectedOrderTransport=this.orderTransportService.getOrderTransport()?this.orderTransportService.getOrderTransport():new OrderTransport();
   this.selectedOrderTransportInfo =this.orderTransportService.getorderTransportInfoRetour()?this.orderTransportService.getorderTransportInfoRetour():new OrderTransportInfo();
   this.selectedAddressContactOrderTransportInfoInitial=this.selectedOrderTransportInfo.addressContactInitial ?this.selectedOrderTransportInfo.addressContactInitial : new AddressContactOrderTransportInfo();
   this.selectedAddressContactOrderTransportInfoFinal=this.selectedOrderTransportInfo.addressContactFinal?this.selectedOrderTransportInfo.addressContactFinal:new AddressContactOrderTransportInfo();
  ...
  this.selectedOrderTransportInfo.orderTransportInfoLines=this.orderTransportInfoLines;
  this.selectedOrderTransportInfo.type=TypeInfo.Retour.toString();
  this.orderTransportService.addOrderTransportInfoRetour(this.selectedOrderTransportInfo);
  ...
  initFormInitial() {
    ...
    this.selectedAddressContactOrderTransportInfoInitial.tel1 = formValue["orderTransportInfoInitialTel1"];
    this.selectedAddressContactOrderTransportInfoInitial.email =
    ...
    this.selectedAddressContactOrderTransportInfoInitial.city = formValue["orderTransportInfoInitialCity"];
    this.selectedAddressContactOrderTransportInfoInitial.zip = formValue["orderTransportInfoInitialZip"];
    this.selectedAddressContactOrderTransportInfoInitial.country =
    ...
    this.selectedAddressContactOrderTransportInfoInitial.date = formValue["orderTransportInfoInitialDate"];

    this.selectedOrderTransportInfo.addressContactInitial=this.selectedAddressContactOrderTransportInfoInitial;
  ...
  initFormFinal() {
    ...
    this.selectedAddressContactOrderTransportInfoFinal.date =
      ...
      this.selectedOrderTransportInfo.addressContactFinal=this.selectedAddressContactOrderTransportInfoFinal;
    }
 ...
 if(this.packageDetails.length==0){
  ...
  packageDetail.id= this.idPackageDetail;
   ...
   if(packageDetail.id==undefined || packageDetail.id== null){
    this.idPackageDetail =this.packageDetails[this.packageDetails.length-1].id;
    this.idPackageDetail--;
    packageDetail.id= this.idPackageDetail;
...
//  line
  ...
  onLineEditedOrderTransportInfoLine(orderTransportInfoLine: OrderTransportInfoLine) {

    this.orderTransportInfoLines =
    this.orderTransportInfoLines.sort(function (a, b) {
    ...
    if(this.orderTransportInfoLines.length==0){
      ...
      orderTransportInfoLine.lineNumber = 1;
       ...
       if(orderTransportInfoLine.id==undefined || orderTransportInfoLine.id== null){
        this.idOrderTransportLine =this.orderTransportInfoLines[this.orderTransportInfoLines.length-1].id;
        this.idOrderTransportLine--;
        orderTransportInfoLine.id=this.idOrderTransportLine;
        let lastLine =this.orderTransportInfoLines[size-1].lineNumber ? this.orderTransportInfoLines[size-1].lineNumber:0;
  ...
  onDeleteOrderTransportInfoLine(id: number) {
    this.confirmationService.confirm({
      message: "Voulez vous vraiment Suprimer?",
      accept: () => {
        this.orderTransportInfoLines = this.orderTransportInfoLines.filter((l) => l.id !== id);
      },
    });
  }
