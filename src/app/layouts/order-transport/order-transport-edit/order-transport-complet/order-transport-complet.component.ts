...
export class OrderTransportCompletComponent implements OnInit {
  ...
  this.selectOrderTransportInfoLineEnlevement=this.orderTransportInfoLines[0];
    this.selectOrderTransportInfoLineLivraison=this.orderTransportInfoLines[1];

    this.onShowDialogOrderTransportInfoLineEnlevement(this.selectOrderTransportInfoLineEnlevement, true);
    this.onShowDialogOrderTransportInfoLineLivraison(this.selectOrderTransportInfoLineLivraison, true);
  ...
  onLineEditedOrderTransportInfoLine(
    ...
    console.log(this.orderTransportInfoLines.length);

    if(this.orderTransportInfoLines.length==2){
    this.validateForm();
    }
  ...
  calculateAllLines() {
    console.log("calculate");
      ...
      this.selectedOrderTransport.totalPriceHT=this.selectedOrderTransport.priceHT;
      this.selectedOrderTransport.totalPriceTTC=this.selectedOrderTransport.priceTTC;
      this.selectedOrderTransport.totalPriceVat=this.selectedOrderTransport.priceVat;
  ...
  onShowDialogTransportProduct(line, mode) {
    ...
    if (mode == true) {
      ...
      this.selectedTransportProductService.account=this.selectedOrderTransport.account;
