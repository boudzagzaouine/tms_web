...
@Component({
  selector: 'app-machine-insurance-edit',
  templateUrl: './machine-insurance-edit.component.html',
  styleUrls: ['./machine-insurance-edit.component.css']
})
export class MachineInsuranceEditComponent implements OnInit {
