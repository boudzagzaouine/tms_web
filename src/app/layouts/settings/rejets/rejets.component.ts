...
@Component({
  ...
  styleUrls: ['./rejets.component.css']
})
export class RejetsComponent implements OnInit {
  ...
  onCodeSearch(event: any) {
    this.subscriptions.add(this.orderTransportRejectTypeService.find('type:1'+',code~' + event.query).subscribe(
