...
export class TurnEditComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.sourceCars = [
      { label: 'Fes', value: 'L12365' },
      { label: 'Fes', value: 'L85252' },
      { label: 'Taza', value: 'L96325' },
      { label: 'Taza', value: 'L741' },
      { label: 'Rabat', value: 'L858520' },
      { label: 'Casa', value: 'L8520028' },
      { label: 'Merakech', value: 'L8520520' },
      { label: 'Asfi', value: 'L8520850' },
      { label: 'Tetouan', value: 'L7896542' },
      { label: 'Agadir', value: 'L96320' },
    ];
