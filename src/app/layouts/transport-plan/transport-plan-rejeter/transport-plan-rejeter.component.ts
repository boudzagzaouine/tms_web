...
@Component({
  selector: 'app-transport-plan-rejeter',
  templateUrl: './transport-plan-rejeter.component.html',
  styleUrls: ['./transport-plan-rejeter.component.css']
})
export class TransportPlanRejeterComponent implements OnInit {
  page = 0;
  size = 10;
...
this.orderTransportRejectTypeService.find('type:1').subscribe(
  data=> {
