...
@Component({
  ...
  templateUrl: './company-account-address-edit.component.html',
  styleUrls: ['./company-account-address-edit.component.css'],
  providers:[ConfirmationService]
})
export class CompanyAccountAddressEditComponent implements OnInit {
