...
export class DeliveryMethodService {
  ...
  findAll(): Observable<DeliveryMethod[]> {
    console.log('from deliveryMethod service findAll');
  ...
  findById(id: number): Observable<DeliveryMethod> {
  ...
  set(deliveryMethod: DeliveryMethod) {
    this.proxy.add(this.controller, deliveryMethod);
  }
