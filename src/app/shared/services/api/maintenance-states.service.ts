...
export class MaintenanceStateService {
    ...
    set(maintenanceState: MaintenanceState): MaintenanceState {
        this.proxy.set(this.controller, maintenanceState).subscribe(
            data => {
                this.emitChanges();
    ...
    delete(maintenanceState: MaintenanceState) {
        this.proxy.delete(this.controller, maintenanceState.id).subscribe(
            data => {
                this.emitChanges();
                  this.toastr.success(
