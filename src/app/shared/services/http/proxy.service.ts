...
export class ProxyService {
    ...
    generateAccountInvocieFromSaleOrder(controller: string, saleOrder: SaleOrder): Observable<Object> {
        return this.http.post(this.url + controller + '/genereteInvoice?token=' + this.getToken(), saleOrder);
    }

    generateDeliveryFromSaleOrder(controller: string, saleOrder: SaleOrder): Observable<any> {
        return this.http.post(this.url + controller + '/generateFromParent?token=' + this.getToken(), saleOrder);
    }
